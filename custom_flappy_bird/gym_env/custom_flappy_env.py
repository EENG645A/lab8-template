...
class CustomFlappyBirdEnv(FlappyBirdEnv):
    ...
    Uses the 0.3.0 version on pip for :
    https://github.com/markub3327/flappy-bird-gymnasium/tree/v0.3.0
    """
    ...
    def __init__(self, env_config={},
                 ...
                 background: str | None = "day") -> None:
        # This enables env_configs passed through ray
        # to overwrite  __init__ args
        ...
        super().__init__(
            screen_size, audio_on, normalize_obs, pipe_gap, bird_color,
            pipe_color, render_mode, background
        )

    def step(
        self, action: FlappyBirdLogic.Actions | int
        ...
        # HINT: look for a self method that is obviously named in the
        # parent env class.
